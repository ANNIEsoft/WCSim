...
#ifndef GdNeutronHPCaptureANNRI_h
#define GdNeutronHPCaptureANNRI_h 1

#include "globals.hh"
#include "G4NeutronHPChannel.hh"
#include "G4HadronicInteraction.hh"

class GdNeutronHPCaptureANNRI : public G4HadronicInteraction
{
	public: 

		GdNeutronHPCaptureANNRI(G4String _gdcomposition, G4String _gdcascade);

		~GdNeutronHPCaptureANNRI();
